...
equating(1995) %T>% write_csv(here("outputs/reports/weight_change_table_mean_1995.csv"))
equating(1998) %T>% write_csv(here("outputs/reports/weight_change_table_mean_1998.csv"))
equating(2003) %T>% write_csv(here("outputs/reports/weight_change_table_mean_2003.csv"))
equating(2012) %T>% write_csv(here("outputs/reports/weight_change_table_mean_2012.csv"))